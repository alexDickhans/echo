...
public:
    static Command *skills() {
        return new Sequence({
                ...
                new TankMotionProfiling(drivetrain, {65_in / second, 150_in / second / second}, 15_in, false, -90_deg,
                                        0.0),
                ...
                new TankMotionProfiling(drivetrain, {25_in / second, 60_in / second / second}, -17_in, false, -20_deg,
                                        0.0, true),
                new ScheduleCommand(goalClampTrue),
                new Ramsete(drivetrain, &skills_3, 0.7, 8.0),
                new TankMotionProfiling(drivetrain, {65_in / second, 100_in / second / second}, 14.5_in, false, -45_deg,
                                        0.0, true),
                ...
                new TankMotionProfiling(drivetrain, {10_in / second, 80_in / second / second}, -8_in, false, 180_deg,
